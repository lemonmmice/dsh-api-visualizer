...
.apv-toolbar{display:flex;align-items:center;gap:8px;padding:8px 12px;border-bottom:1px solid var(--dsw-alias-border-subtle,#2a2e37);flex-wrap:wrap}
.apv-title{font-weight:600;font-size:14px;margin-right:4px}
.apv-stats{color:var(--dsw-alias-fg-muted,#9aa0aa);font-size:12px;white-space:nowrap}
.apv-q{flex:1 1 180px;min-width:120px;background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 8px;font:inherit}
.apv-select{background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 6px;font:inherit}
.apv-btn{background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 10px;cursor:pointer;font:inherit}
.apv-btn:hover{background:var(--dsw-alias-bg-hover,#262b35)}
...
.apv-table th{position:sticky;top:0;background:var(--dsw-alias-bg-elevated,#20242c);text-align:left;padding:6px 10px;font-size:12px;color:var(--dsw-alias-fg-muted,#9aa0aa);border-bottom:1px solid var(--dsw-alias-border-subtle,#2a2e37);z-index:1}
.apv-table td{padding:5px 10px;border-bottom:1px solid var(--dsw-alias-border-subtle,#23262e);vertical-align:top;max-width:520px;overflow:hidden;text-overflow:ellipsis}
.apv-table tbody tr{cursor:pointer}
.apv-table tbody tr:hover{background:var(--dsw-alias-bg-hover,#20242c)}
.apv-table tbody tr.apv-selected{background:#1e2a44}
.apv-table tbody tr.apv-selected:hover{background:#1e2a44}
.apv-table tbody tr.apv-selected td:first-child{box-shadow:inset 2px 0 0 #60a5fa}
.apv-empty{text-align:center;color:var(--dsw-alias-fg-muted,#9aa0aa);padding:40px 0}
.apv-badge{display:inline-block;padding:1px 6px;border-radius:4px;font-size:11px;font-weight:600}
.apv-m-get{background:#1b4d3a;color:#4ade80}.apv-m-post{background:#1e3a5f;color:#60a5fa}.apv-m-put{background:#4a3b14;color:#fbbf24}
.apv-m-delete{background:#4c1d1d;color:#f87171}.apv-m-other{background:#33363f;color:#cbd5e1}
.apv-s-2{background:#1b4d3a;color:#4ade80}.apv-s-3{background:#1e3a5f;color:#60a5fa}.apv-s-4{background:#4a3b14;color:#fbbf24}
.apv-s-5{background:#4c1d1d;color:#f87171}.apv-s-0{background:#33363f;color:#cbd5e1}
.apv-note{color:var(--dsw-alias-fg-muted,#9aa0aa);font-size:12px}
.apv-detail{display:flex;flex-direction:column;border-top:1px solid var(--dsw-alias-border-subtle,#2a2e37);max-height:45%;min-height:120px}
.apv-detail[hidden]{display:none}
.apv-detail-head{display:flex;align-items:center;gap:8px;padding:6px 12px;background:var(--dsw-alias-bg-elevated,#20242c)}
.apv-detail-head .apv-durl{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-fg-muted,#9aa0aa);font-size:12px}
.apv-detail pre{flex:1;overflow:auto;margin:0;padding:10px 12px;font:12px/1.5 Consolas,Menlo,monospace;color:#9fe8a0;white-space:pre-wrap;word-break:break-all}
...
.apv-entry:hover{background:var(--dsw-alias-bg-hover,#20242c)}
.apv-entry[data-active]{background:var(--dsw-alias-bg-hover,#20242c)}
...
.apv-autoscroll{display:flex;align-items:center;gap:4px;font-size:12px;color:var(--dsw-alias-fg-muted,#9aa0aa);white-space:nowrap;cursor:pointer}
.apv-sep{color:var(--dsw-alias-border-subtle,#2a2e37)}
.apv-port{width:64px;background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 6px;font:inherit}
.apv-btn-danger:hover{border-color:#c0392b;color:#e74c3c}
.apv-btn-on{border-color:#2ecc71;color:#2ecc71}
.apv-star{background:none;border:none;color:var(--dsw-alias-fg-muted,#9aa0aa);cursor:pointer;font-size:15px;padding:0 4px;line-height:1}
.apv-star[data-on="1"]{color:#fbbf24}
.apv-detail-bar{display:flex;align-items:center;gap:8px;padding:6px 12px;border-top:1px solid var(--dsw-alias-border-subtle,#2a2e37);flex-wrap:wrap}
.apv-detail-bar .apv-in{background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 8px;font:inherit}
...
.apv-sec-title{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--dsw-alias-fg-muted,#9aa0aa);margin-bottom:4px}
.apv-sec-title .apv-t{font-weight:600}
.apv-sec-pre{margin:0;padding:8px 10px;font:12px/1.5 Consolas,Menlo,monospace;color:#9fe8a0;white-space:pre-wrap;word-break:normal;overflow-wrap:anywhere;background:var(--dsw-alias-bg-elevated,#20242c);border-radius:6px;max-height:340px;overflow:auto}
.apv-sec-body{background:var(--dsw-alias-bg-elevated,#20242c);border-radius:6px;padding:8px 10px;max-height:340px;overflow:auto}
.apv-viewbtns{display:flex;gap:4px;margin-left:auto}
.apv-viewbtns .apv-btn{padding:2px 8px;font-size:11px}
[data-apv-back-entry]{background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:var(--dsw-alias-fg-muted,#9aa0aa);border-radius:6px;padding:4px 10px;cursor:pointer;font:inherit;white-space:nowrap}
[data-apv-back-entry]:hover{color:#8ec5ff;border-color:#8ec5ff}
.apv-jt{font:12px/1.6 Consolas,Menlo,monospace}
.apv-jt-row{white-space:pre}
.apv-jt-toggle{cursor:pointer;user-select:none}
.apv-jt-toggle:hover{color:#8ec5ff}
.apv-jt-collapsed::after{content:' …';color:var(--dsw-alias-fg-muted,#9aa0aa)}
.apv-jt-brace{color:var(--dsw-alias-fg-muted,#9aa0aa)}
.apv-jt-key{color:#8ec5ff}
.apv-jt-idx{color:var(--dsw-alias-fg-muted,#9aa0aa)}
.apv-jt-str{color:#9fe8a0}
.apv-jt-num{color:#fbbf24}
.apv-jt-bool,.apv-jt-null{color:#c4a7f0}
.apv-jt-kids{border-left:1px solid var(--dsw-alias-border-subtle,#2a2e37);margin-left:8px;padding-left:8px}
.apv-mark{background:#7c5c00;color:#fff;border-radius:2px;padding:0 1px}
.apv-img{max-width:100%;max-height:320px;border-radius:6px;display:block}
.apv-iframe{width:100%;height:320px;border:1px solid var(--dsw-alias-border-subtle,#2a2e37);border-radius:6px;background:#fff}
.apv-filterbar{display:flex;flex-direction:column;gap:6px;padding:8px 12px;border-bottom:1px solid var(--dsw-alias-border-subtle,#2a2e37);flex-wrap:wrap}
.apv-filterbar[hidden]{display:none}
.apv-frow{display:flex;align-items:center;gap:6px;flex-wrap:wrap}
.apv-fin{background:var(--dsw-alias-bg-elevated,#20242c);border:1px solid var(--dsw-alias-border-subtle,#2a2e37);color:inherit;border-radius:6px;padding:4px 8px;font:inherit}
.apv-fin-host{width:150px}.apv-fin-ct{width:150px}.apv-fin-dur{width:90px}.apv-fin-body{flex:1 1 160px;min-width:120px}
.apv-fcb{display:flex;align-items:center;gap:4px;font-size:12px;color:var(--dsw-alias-fg-muted,#9aa0aa);white-space:nowrap;cursor:pointer}
